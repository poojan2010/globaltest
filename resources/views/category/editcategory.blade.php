...
@section('content')
    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-4">
                @if($is_form == '1')
                <form action="{{ route('update.category',['id' => $data->id]) }}" method=POST style="margin-top: 50%;">
                    @csrf
                    <div class="mb-3">
                ...
                @if($is_form == '2') 
                <form action="{{ route('update.subcategory',['id' => $subcategory->id]) }}" method=POST style="margin-top: 50%;">
                    @csrf
                    <div class="mb-3">
                ...
                @if($is_form == '3')
                <form action="{{ route('update.subsubcategory',['id' => $subsubcategory->id]) }}" method=POST style="margin-top: 50%;">
                    @csrf
                    <div class="mb-3">
